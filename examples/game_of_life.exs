defmodule GameOfLife do
  ...
  def run(width, height, iterations) do
    field = M.random({width, height}, :bool)
  ...
  defp cell_at(%Matrex{shape: {rows, cols}}, r, c) when r < 1 or c < 1 or r > rows or c > cols,
    do: 0

  defp cell_at(fld, r, c), do: M.at(fld, {r, c})
